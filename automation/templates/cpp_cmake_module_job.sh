...
function job()
{
    ...
    local log_prefix="[cpp_cmake_module_job]: "
    ...
    log "Create CMake C++ module '$module_name' in '$target_path'"
    ...
    cp -a $templates_dir/CMake/Module/. $target_path
